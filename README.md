# Qtruck Documentation

This repository contains the Qtruck VitePress documentation site. The
...
The staged production files are generated in `projects/Qtruck/en/latest/`.
...
```text
https://hiwonder-docs.github.io/Qtruck-vite/projects/Qtruck/en/latest/
```

The public-facing URL (via the baota Nginx reverse proxy) is:

```text
https://wiki-test.hiwonder.com/projects/Qtruck/en/latest/
```
